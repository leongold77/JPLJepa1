...
def main():
    ...
    # ----------------------------------------------------------------------- #
    fname = 'jepa/configs/evals/vith16_384_k400_16x8x3.yaml'
    ...
    latest_path = 'vith16-384-k400-probe.pth.tar'
    ...
    val_data_path = 'test_all/test.txt'
    if 1:
        try:
